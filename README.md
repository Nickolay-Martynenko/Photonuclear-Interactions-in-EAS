...
These datasets were produced by the author using **[CONEX v7.80](https://gitlab.iap.kit.edu/AirShowerPhysics/cxroot/-/tree/2f795057e7d35ba2233dba77b791e51143bec3b4/)** for extensive air shower simulations.
...
3. Run the demo script to ensure everything is working correctly:
   ...
   239616 * {Shower_Id: uint32, Shower_Log10Energy: float32, Shower_ParticleId: uint16, PNRXsection_AsymptRatioModified2EGS4: float32, PNRXsection_Log10EnergyTransitionEGS42Modified: float32, MuonSlantDepth: 201 * float32, MuonNumber: 201 * float32}
   ```
